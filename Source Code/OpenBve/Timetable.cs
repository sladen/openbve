            ...
            if (t >= 0) {
                ...
                if (c >= 0) {
                    ...
                    if (s >= 0) {
                        ...
                        if (e >= 0) {
                            if (TrainManager.Trains[t].Cars[c].Sections[s].Elements[e].States.Length != 0) {
                                if (TrainManager.Trains[t].Cars[c].Sections[s].Elements[e].States[0].Object.Meshes.Length != 0) {
                                    if (TrainManager.Trains[t].Cars[c].Sections[s].Elements[e].States[0].Object.Meshes[0].Materials.Length != 0) {
                                        if (DaytimeTextureIndex >= 0) {
                                            TrainManager.Trains[t].Cars[c].Sections[s].Elements[e].States[0].Object.Meshes[0].Materials[0].DaytimeTextureIndex = DaytimeTextureIndex;
                                        }
                                        if (NighttimeTextureIndex >= 0) {
                                            TrainManager.Trains[t].Cars[c].Sections[s].Elements[e].States[0].Object.Meshes[0].Materials[0].NighttimeTextureIndex = NighttimeTextureIndex;
                                        }
