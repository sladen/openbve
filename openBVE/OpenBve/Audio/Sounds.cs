...
namespace OpenBve {
	internal static partial class Sounds {
		...
		/// <summary>The speed by which the outer radius factor is changed.</summary>
		internal static double OuterRadiusFactorSpeed;
		
		/// <summary>The minimum value the outer radius factor can take. Is influenced by the user's settings.</summary>
		internal static double OuterRadiusFactorMinimum;
		
		/// <summary>The maximum value the outer radius factor can take. Is influenced by the user's settings.</summary>
