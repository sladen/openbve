                                    ...
                                    switch (Command.ToLowerInvariant()) {
                                        ...
                                        case "value":
                                            if (Arguments.Length == 1) {
                                                ...
                                                float a, b;
                                                if (!float.TryParse(Arguments[0], System.Globalization.NumberStyles.Float, Culture, out a)) {
                                                    System.Windows.Forms.MessageBox.Show("VALUE1 is invalid in " + Command + " at line " + (i + 1).ToString(Culture) + " in " + File);
                                                } else if (!float.TryParse(Arguments[1], System.Globalization.NumberStyles.Float, Culture, out b)) {
