...
namespace OpenBve {
    public partial class formLoading : Form {
        ...
        private void formLoading_Load(object sender, EventArgs e) {
            try {
                string f = Interface.GetCombinedFileName(Interface.GetCombinedFolderName(Application.StartupPath, "Interface"), "banner.png");
        ...
        private void ShowMessages() {
            ...
            string Folder = Interface.GetCombinedFolderName(Application.StartupPath, "Graphics");
            try {
                listviewProblems.SmallImageList.Images.Add("information", Image.FromFile(Interface.GetCombinedFileName(Folder, "information.png")));
            } catch { }
            try {
                listviewProblems.SmallImageList.Images.Add("warning", Image.FromFile(Interface.GetCombinedFileName(Folder, "warning.png")));
            } catch { }
            try {
                listviewProblems.SmallImageList.Images.Add("error", Image.FromFile(Interface.GetCombinedFileName(Folder, "error.png")));
            } catch { }
            for (int i = 0; i < Interface.MessageCount; i++) {
                string t = "Unknown";
