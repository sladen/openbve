    ...
    internal static class PluginManager {
        ...
        internal static bool LoadAtsConfig(string TrainPath, System.Text.Encoding Encoding, TrainManager.Train Train) {
            ...
            if (Program.CurrentPlatform == Program.Platform.Windows) {
                ...
                Interface.AddMessage(Interface.MessageType.Information, false, "The operating system does not support loading train security system plugins. The built-in security systems will be used for this train.");
                return false;
            }
        }
