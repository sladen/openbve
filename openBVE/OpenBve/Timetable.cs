                    ...
                    if (s >= 0) {
                        ...
                        if (e >= 0) {
                            if (TrainManager.Trains[t].Cars[c].Sections[s].Elements[e].States.Length != 0) {
                                if (TrainManager.Trains[t].Cars[c].Sections[s].Elements[e].States[0].Object.Mesh.Materials.Length != 0) {
                                    if (DaytimeTextureIndex >= 0) {
                                        TrainManager.Trains[t].Cars[c].Sections[s].Elements[e].States[0].Object.Mesh.Materials[0].DaytimeTextureIndex = DaytimeTextureIndex;
                                    }
                                    if (NighttimeTextureIndex >= 0) {
                                        TrainManager.Trains[t].Cars[c].Sections[s].Elements[e].States[0].Object.Mesh.Materials[0].NighttimeTextureIndex = NighttimeTextureIndex;
                                    }
