...
namespace OpenBve {
	...
	internal static class Fonts {
		...
		internal static readonly OpenGlFont SmallFont = new OpenGlFont(FontFamily.GenericSansSerif, 11.0f);
		
		/// <summary>Represents a normal-sized sans serif font.</summary>
		internal static readonly OpenGlFont NormalFont = new OpenGlFont(FontFamily.GenericSansSerif, 14.0f);

		/// <summary>Represents a large sans serif font.</summary>
		internal static readonly OpenGlFont LargeFont = new OpenGlFont(FontFamily.GenericSansSerif, 18.0f);

		/// <summary>Represents a very large sans serif font.</summary>
		internal static readonly OpenGlFont VeryLargeFont = new OpenGlFont(FontFamily.GenericSansSerif, 23.0f);
