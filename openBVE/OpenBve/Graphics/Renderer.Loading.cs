...
namespace OpenBve {
	internal static partial class Renderer {
		...
		internal static void DrawLoadingScreen() {
			...
			DrawString(Fonts.NormalFont, text, new Point((Screen.Width - size) / 2 + 5, Screen.Height - (int)(Fonts.NormalFont.FontSize / 2) - 5), TextAlignment.CenterLeft, Color128.White);
			// end HACK //
